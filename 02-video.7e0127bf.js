 ...
 */var M=function(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"addEventListener",o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:"removeEventListener",i="string"==typeof t?[t]:t;return i.forEach(function(t){e[r](t,n)}),{cancel:function(){return i.forEach(function(t){return e[o](t,n)})}}},S=void 0!==Array.prototype.indexOf,F="undefined"!=typeof window&&void 0!==window.postMessage;if(!T&&(!S||!F))throw Error("Sorry, the Vimeo Player API is not available in this browser.");var C="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==u?u:"undefined"!=typeof self?self:{};!/*!
...
u=setTimeout(v,t),h(c))}return void 0===u&&(u=setTimeout(v,t)),a}return t=ed(t)||0,ef(n)&&(s=!!n.leading,i=(f="maxWait"in n)?ec(ed(n.maxWait)||0,t):i,d="trailing"in n?!!n.trailing:d),m.cancel=function(){void 0!==u&&clearTimeout(u),l=0,r=c=o=u=void 0},m.flush=function(){return void 0===u?a:y(es())},m}(e,t,{leading:r,maxWait:t,trailing:o})};let eh=document.getElementById("vimeo-player"),ep=new Q(eh),ev=((a=J)&&a.__esModule?a.default:a)(e=>{localStorage.setItem("videoplayer-current-time",e)},1e3);ep.on("timeupdate",function(e){let t=e.seconds;ev(t)}),window.addEventListener("load",()=>{let e=localStorage.getItem("videoplayer-current-time");e&&ep.setCurrentTime(parseFloat(e))})}();//# sourceMappingURL=02-video.7e0127bf.js.map

//# sourceMappingURL=02-video.7e0127bf.js.map
