var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},e={},n={},r={};r=/**
 ...
 */function(t,e,o){var i=!0,a=!0;if("function"!=typeof t)throw TypeError("Expected a function");return r(o)&&(i="leading"in o?!!o.leading:i,a="trailing"in o?!!o.trailing:a),n(t,e,{leading:i,maxWait:e,trailing:a})};const W=document.querySelector(".feedback-form"),$="feedback-form-state";let k={};const J=e(t=>{k[t.target.name]=t.target.value.trim(),localStorage.setItem($,JSON.stringify(k))},500);W.addEventListener("input",J),W.addEventListener("submit",function(t){t.preventDefault(),localStorage.removeItem($),console.log(k),k={},t.target.reset()}//# sourceMappingURL=03-feedback.0694748f.js.map
),document.addEventListener("DOMContentLoaded",function(){try{let t=localStorage.getItem($);if(!t)return;k=JSON.parse(t),Object.entries(k).forEach(([t,e])=>{W.elements[t].value=e})}catch(t){console.log(t.message)}});
//# sourceMappingURL=03-feedback.0694748f.js.map
