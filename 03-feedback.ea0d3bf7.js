!function(){var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},t={},n={},r={};r=/**
 ...
 */function(e,t,i){var o=!0,a=!0;if("function"!=typeof e)throw TypeError("Expected a function");return r(i)&&(o="leading"in i?!!i.leading:o,a="trailing"in i?!!i.trailing:a),n(e,t,{leading:o,maxWait:t,trailing:a})};let M=document.querySelector(".feedback-form"),N=M.querySelector('input[name="email"]'),W=M.querySelector('textarea[name="message"]'),$=t(()=>{let e={email:N.value,message:W.value};localStorage.setItem("feedback-form-state",JSON.stringify(e))},500);N.addEventListener("input",$),W.addEventListener("input",$),document.addEventListener("DOMContentLoaded",function(){let e=localStorage.getItem("feedback-form-state");if(e){let t=JSON.parse(e);N.value=t.email,W.value=t.message}}),M.addEventListener("submit",function(e){e.preventDefault(),localStorage.removeItem("feedback-form-state");let t={email:N.value,message:W.value};console.log(t),N.value="",W.value=""})}();//# sourceMappingURL=03-feedback.ea0d3bf7.js.map

//# sourceMappingURL=03-feedback.ea0d3bf7.js.map
